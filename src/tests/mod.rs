...
#[test]
fn line() -> Result<()> {
    let (actual, expected) = compare(6, 5, &[Line::new((0, 0), (6, 6))], MergeAlgorithm::Replace)?;
    assert_eq!(actual, expected);
    Ok(())
}
...
#[test]
fn line2() -> Result<()> {
    let (actual, expected) = compare(6, 6, &[Line::new((6, 6), (0, 0))], MergeAlgorithm::Replace)?;
    assert_eq!(actual, expected);
    Ok(())
}
...
fn line_vertical() -> Result<()> {
    let (actual, expected) = compare(5, 5, &[Line::new((2, 1), (2, 4))], MergeAlgorithm::Replace)?;
    assert_eq!(actual, expected);
    Ok(())
}
...
fn line_horizontal() -> Result<()> {
    let (actual, expected) = compare(5, 5, &[Line::new((1, 2), (4, 2))], MergeAlgorithm::Replace)?;
    assert_eq!(actual, expected);
    Ok(())
}
